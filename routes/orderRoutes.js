...
// POST /api/orders - Create a new order (public route)
...
//   }
// });
// Backend Routes (add these to your existing order routes file)

// Get user orders (existing route)
router.get('/user/:userId', async (req, res) => {
  try {
    const orders = await Order.find({ user: req.params.userId })
...
router.get('/:orderId', async (req, res) => {
  try {
    ...
    // Check if user owns this order (if you have user authentication)
    // Uncomment and modify this section based on your auth implementation
    /*
