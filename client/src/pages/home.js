...
const handleChange = (e) => {
  ...
  // For outside Karachi, only online payment is allowed
  if (!inKarachi && orderData.paymentMethod === 'cod') {
    alert('Cash on Delivery is only available in Karachi. Please select online payment.');
    return;
  }

  // For online payment (both Karachi and outside), payment slip is required
