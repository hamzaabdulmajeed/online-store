...
const ProductCard = ({ product }) => {
 ...
 // Helper function to render color names
const renderColors = () => {
...
// Helper function to render all sizes
const renderSizes = () => {
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Mobile styles - Made larger for better visibility */
    ...
    <div style={{ 
     ...
     <style>{`
        ...
        * {
        ...
        /* Ensure ProductCard fills container properly */
        .product-grid > div {
          max-width: 100%;
          min-width: 0;
          width: 100%;
